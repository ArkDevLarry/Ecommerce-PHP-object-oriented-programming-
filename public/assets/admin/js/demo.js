  ...
  initLBDWizard: function () {
    var $validator = $("#wizardForm").validate({
      rules: {
        ...
        first_name: { required: false, minlength: 5 },
        last_name: { required: false, minlength: 5 },
        website: { required: true, minlength: 5, url: true },
        framework: { required: false, minlength: 4 },
      ...
      select: function (start, end) {
        swal(
          ...
          function () {
            ...
            if (event_title) {
              eventData = { title: event_title, start: start, end: end };
    ...
    $.notify(
      {
        ...
        message:
          "Welcome to <b>Eshop Management: Admin</b> - all products, categories, brands etc. are created and managed here.",
      },
      {
        type: type[color],
        timer: 8000,
