    ...
    <main>
                    ...
                    <div class="col-xl-7">
                        <div class="swiper-container slider__active pb-30">
                            <div class="slider-wrapper swiper-wrapper">
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="<?=ASSET.FRNTND.'img/slider/02-slide-1.jpg'?>">
                                ...
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="<?=ASSET.FRNTND.'img/slider/02-slide-2.jpg'?>">
                                    <div class="slider-content slider-content-2">
                                ...
                                <div class="single-slider b-radius-2 swiper-slide slider-height-2 d-flex align-items-center" data-background="<?=ASSET.FRNTND.'img/slider/02-slide-3.jpg'?>">
                                    <div class="slider-content slider-content-2">
                    ...
                    <div class="col-xl-5">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-10.jpg'?>" alt=""></a>
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-11.jpg'?>" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-13.jpg'?>" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-12.jpg'?>" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
        ...
        <section class="trending-product-area light-bg-s pt-25 pb-15">
            <div class="container custom-conatiner">
                ...
                <div class="row">
                    <?php 
                        foreach($hot_deals as $k => $deal) {?>
                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="<?=ROOT.'product_details/'.$deal['prods']->slug?>">
                                        <img src="<?=ASSET.'uploads/product/'.$deal['imgs']->image?>" alt="product">
                                    </a>
                                </div>
                            ...
                            <div class="product__content product__content-2">
                                <h6 style="height: 36px; text-transform: capitalize;" title="<?=$deal['prods']->name?>"><a href="product-details.html"><?=strlen($deal['prods']->name) > 35 ? subStr($deal['prods']->name, 0,32).'...' : $deal['prods']->name?></a></h6>
                                ...
                                <div class="price">
                                    <span>$<?=number_format($deal['prods']->price)?></span>
                                </div>
                            </div>
            ...
            <div class="container custom-conatiner">
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-1.jpg'?>" alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-2.jpg'?>" alt=""></a>
                            </div>
                            <div class="categories__content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-3.jpg'?>" alt=""></a>
                            </div>
                            <div class="categories__content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-4.jpg'?>" alt=""></a>
                            </div>
                            <div class="categories__content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-5.jpg'?>" alt=""></a>
                            </div>
                            <div class="categories__content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/categorie/cat-6.jpg'?>" alt=""></a>
                            </div>
                            <div class="categories__content">
                                ...
                                <div class="col-lg-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fpb-1.jpg'?>" alt=""></a>
                                        </div>
                                        <div class="product__offer">
                                            <span class="discount">-15%</span>
                                        </div>
                        ...
                        <div class="single-features-item single-features-item-d single-features-item-d-2 b-radius-2 mb-20">
                            <div class="row  g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fpb-2.jpg'?>" alt=""></a>
                                        </div>
                                        <div class="product-action product-action-2">
                                            <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                <i class="fal fa-eye"></i>
            ...
            <div class="container custom-conatiner">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative w-img mb-30">
                            <div class="banner__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-14.jpg'?>" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-15.jpg'?>" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img b-radius-2">
                                <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/banner/banner-16.jpg'?>" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                        ...
                        <div class="single-features-item single-features-item-d b-radius-2 mb-20">
                            <div class="row  g-0 align-items-center">
                                <div class="col-md-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fpsm-1.jpg'?>" alt=""></a>
                                        </div>
                                        <div class="product__offer">
                                            <span class="discount">-15%</span>
                                        </div>
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fp-1.jpg'?>" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                                    <span class="discount">-15%</span>
                                                </div>
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fp-2.jpg'?>" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fp-3.jpg'?>" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="product-details.html"><img src="<?=ASSET.FRNTND.'img/features-product/fp-4.jpg'?>" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                            ...
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-1.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product__offer">
                                <span class="discount">-15%</span>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-2.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-3.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product__offer">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-7.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-10.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="product-details.html">
                                        <img src="<?=ASSET.FRNTND.'img/product/tp-9.jpg'?>" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                ...
                <div class="row">
                        ...
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-1.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">Digital</a>
                                </div>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4">
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-2.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">New</a>
                                </div>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4">
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-3.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">Update</a>
                                </div>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4">
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-4.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">Offer</a>
                                </div>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4">
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-5.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">Common</a>
                                </div>
                    ...
                    <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4">
                        <div class="single-smblog mb-30">
                            <div class="smblog-thum">
                                <div class="blog-image w-img">
                                    <a href="blog-details.html"><img src="<?=ASSET.FRNTND.'img/blog/sm-b-6.jpg'?>" alt=""></a>
                                </div>
                                <div class="blog-tag">
                                    <a href="#">Hot</a>
                                </div>
                ...
                <div class="brand-slider brand-slider-2 swiper-container pt-35 pb-30">
                    <div class="swiper-wrapper">
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-1.jpg'?>" alt="brand"></a>
                        </div>
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-2.jpg'?>" alt="brand"></a>
                        </div>
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-3.jpg'?>" alt="brand"></a>
                        </div>
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-4.jpg'?>" alt="brand"></a>
                        </div>
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-5.jpg'?>" alt="brand"></a>
                        </div>
                        <div class="brand-item w-img swiper-slide">
                            <a href="#"><img src="<?=ASSET.FRNTND.'img/brand/brand-6.jpg'?>" alt="brand"></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-content" id="modalTabContent">
                                    <div class="tab-pane fade show active" id="nav1" role="tabpanel" aria-labelledby="nav1-tab">
                                        <div class="product__modal-img w-img">
                                            <img src="<?=ASSET.FRNTND.'img/quick-view/quick-view-1.jpg'?>" alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav2" role="tabpanel" aria-labelledby="nav2-tab">
                                        <div class="product__modal-img w-img">
                                            <img src="<?=ASSET.FRNTND.'img/quick-view/quick-view-2.jpg'?>" alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav3" role="tabpanel" aria-labelledby="nav3-tab">
                                        <div class="product__modal-img w-img">
                                            <img src="<?=ASSET.FRNTND.'img/quick-view/quick-view-3.jpg'?>" alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav4" role="tabpanel" aria-labelledby="nav4-tab">
                                        <div class="product__modal-img w-img">
                                            <img src="<?=ASSET.FRNTND.'img/quick-view/quick-view-4.jpg'?>" alt="">
                                        </div>
                                    </div>
                                    </div>
                                <ul class="nav nav-tabs" id="modalTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="nav1-tab" data-bs-toggle="tab" data-bs-target="#nav1" type="button" role="tab" aria-controls="nav1" aria-selected="true">
                                            <img src="<?=ASSET.FRNTND.'img/quick-view/quick-nav-1.jpg'?>" alt="">
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="nav2-tab" data-bs-toggle="tab" data-bs-target="#nav2" type="button" role="tab" aria-controls="nav2" aria-selected="false">
                                        <img src="<?=ASSET.FRNTND.'img/quick-view/quick-nav-2.jpg'?>" alt="">
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="nav3-tab" data-bs-toggle="tab" data-bs-target="#nav3" type="button" role="tab" aria-controls="nav3" aria-selected="false">
                                        <img src="<?=ASSET.FRNTND.'img/quick-view/quick-nav-3.jpg'?>" alt="">
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="nav4-tab" data-bs-toggle="tab" data-bs-target="#nav4" type="button" role="tab" aria-controls="nav4" aria-selected="false">
                                        <img src="<?=ASSET.FRNTND.'img/quick-view/quick-nav-4.jpg'?>" alt="">
                                        </button>
                                    </li>
                                    </ul>
                            </div>
